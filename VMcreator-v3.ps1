...
do {
    ...
    Write-Host "      3) Windows Server 2019 Datacenter - x64 Gen2 (RDP enabled)"
    Write-Host "======================================================" -ForegroundColor Cyan
    $OSChoice = Read-Host "Which OS to install. Enter choice (1, 2, or 3)"
    switch ($OSChoice) {
        ...
        "3" { $OSType = "Windows"; $Image = "MicrosoftWindowsServer:WindowsServer:2019-Datacenter-gensecond:latest"; $Port = "3389"; $Valid = $true }
        default { 
        Clear-Host
